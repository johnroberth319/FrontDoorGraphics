...
const GLfloat doorAngleSpeed = 0.75f;
...
void openDoor() {
    if (doorAngle >= 90.0f) {
        ...
        if (doorAngle <= 90.0f && (doorAngle + doorAngleSpeed) <= 90.0f ) {
...
void closeDoor() {
    if (doorAngle <= 0.0f) {
        ...
        if (doorAngle >= 0.0f && (doorAngle - doorAngleSpeed) >= 0.0f) {
            doorAngle -= doorAngleSpeed;
        }
    }
}
...
int main()
{
    ...
    GLfloat vertices[] = {
        ...
        -2.575f, -3.4f, -4.0f, 0.0f, 0.0f,
        -2.575f, 4.3f, -4.0f, 0.0f, 1.0f,
        ...
        -3.55f, -4.7f, -0.05f, 0.0f, 0.0f,
        -3.55f, 4.79f, -0.05f, 0.0f, 1.0f,
        0.0f, 4.79f, -0.05f, 1.0f, 1.0f,

        -3.55f, -4.7f, -0.05f, 0.0f, 0.0f,
        0.0f, -4.7f, -0.05f, 1.0f, 0.0f,
        0.0f, 4.79f, -0.05f, 1.0f, 1.0f,

        // Draw Front Door - Left
        -3.55f, -4.7f, -0.25f, 0.0f, 0.0f,
        -3.55f, 4.79f, -0.25f, 0.0f, 1.0f,
        -3.55f, 4.79f, -0.05f, 1.0f, 1.0f,

        -3.55f, -4.7f, -0.25f, 0.0f, 0.0f,
        -3.55f, -4.7f, -0.05f, 1.0f, 0.0f,
        -3.55f, 4.79f, -0.05f, 1.0f, 1.0f,

        // Draw Front Door - Right
        0.0f, -4.7f, -0.05f, 0.0f, 0.0f,
        0.0f, 4.79f, -0.05f, 0.0f, 1.0f,
        0.0f, 4.79f, -0.25f, 1.0f, 1.0f,

        0.0f, -4.7f, -0.05f, 0.0f, 0.0f,
        0.0f, -4.7f, -0.25f, 1.0f, 0.0f,
        0.0f, 4.79f, -0.25f, 1.0f, 1.0f,

        // Draw Front Door - Top
        -3.55f, 4.79f, -0.05f, 0.0f, 0.0f,
        -3.55f, 4.79f, -0.25f, 0.0f, 1.0f,
        0.0f, 4.79f, -0.25f, 1.0f, 1.0f,
        ...
        0.0f, -4.7f, -0.25f, 0.0f, 0.0f,
        0.0f, 4.79f, -0.25f, 0.0f, 1.0f,
        -3.55f, 4.79f, -0.25f, 1.0f, 1.0f,

        0.0f, -4.7f, -0.25f, 0.0f, 0.0f,
        -3.55f, -4.7f, -0.25f, 1.0f, 0.0f,
        -3.55f, 4.79f, -0.25f, 1.0f, 1.0f,


        // Draw Front Door Seal - Front

        // Draw Front Door Seal - Left

        // Draw Front Door Seal - Right

        // Draw Front Door Seal - Bottom
    ...
    GLuint texture1, textureFloor, textureCeiling, textureCitro;
    // ====================
    // Texture 1
    // ====================
    ...
    int width, height;
    unsigned char* image = SOIL_load_image("YellowTexture.png", &width, &height, 0, SOIL_LOAD_RGB);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            glDrawArrays(GL_TRIANGLES, 67 * 6, 62 * 6);
        }
        // Upper Blinds
        for (int i = 0; i < 10; i++) {
            glm::mat4 windowBlind = glm::mat4(1.0f);
        ...
        for (int i = 0; i < 2; i++) {
            ...
            glm::vec3 adjustedPos = glm::vec3(objectPositions[i+2].x, objectPositions[i+2].y - 0.07f + (0.19f * std::cos(glm::radians(windowAngle[i]))), objectPositions[i+2].z + (0.19f * std::sin(glm::radians(windowAngle[i]))));
            windowRod = glm::translate(windowRod, adjustedPos);
            glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(windowRod));
            glDrawArrays(GL_TRIANGLES, 129 * 6, 36 * 6);
        }
